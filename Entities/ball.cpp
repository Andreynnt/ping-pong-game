...
void ball::Update(sf::RenderWindow *window) {
    if (this->CheckCollision(this->player1)) {
        ...
        if (this->velocity.y > 0){
            ...
            }else if(this->player1->velocity.y < 0 && this->velocity.y != 5.5f){
    ...
    if (this->CheckCollision(this->player2)) {
        ...
        if (this->velocity.y > 0){
            if (this->player2->velocity.y > 0) {
                this->velocity.y *= 1.30f;
            }else if(this->player2->velocity.y < 0 && this->velocity.y != 5.5f ){
                this->velocity.y = 5.5f;
            }
        }else if(this->velocity.y < 0){
            if (this->player2->velocity.y < 0) {
...
void ball::Reset(sf::RenderWindow *window) {
    this->velocity.x = ((rand() % 2) == 0) ? 5.5f : -5.5f;
    this->velocity.y = ((rand() % 2) == 0) ? 5.5f : -5.5f;
